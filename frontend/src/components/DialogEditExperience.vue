        ...
        <v-card-text class="pt-6">
          ...
          <v-form ref="form2" v-model="valid2" lazy-validation>
            ...
            <v-textarea
              ...
              label="Descrição"
              counter="500"
              v-model="cloneInputs.description"
            ></v-textarea>
          </v-form>
        </v-card-text>
...
export default {
  ...
  methods: {
    ...
    async updateExperience(obj) {
      ...
      const { data } = await ApiService.put(`clients/api/experience.php`, tmp);
